...
def fill(cursor, tablename=[]):
    fake_data = defaultdict(list)
    if ("roles" in tablename): fill_roles(cursor)
    if ("users" in tablename): fill_users(cursor)
    if ("categories" in tablename): fill_categories(cursor)
    if ("tags" in tablename): fill_tags(cursor)
    if ("pages" in tablename): fill_pages(cursor)
    if ("communities" in tablename): fill_communities(cursor)
    if ("posts" in tablename): fill_posts(cursor)
    if ("comments" in tablename): fill_comments(cursor)
